  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#101512] text-slate-100">
      <nav className="sticky top-0 z-50 border-b border-slate-800/80 bg-[#0a1612]/90 shadow-md shadow-black/20 backdrop-blur">
        <div className="app-chrome-inner mx-auto flex w-full max-w-[1480px] items-center justify-between gap-3 px-4 py-3 sm:px-6 md:px-8">
      ...
      <footer className="border-t border-slate-800/80 bg-[#0b1310]/80">
        <div className="app-footer-inner mx-auto flex w-full max-w-[1920px] justify-center px-8 py-3 text-sm text-slate-400 md:px-10">
          <a
